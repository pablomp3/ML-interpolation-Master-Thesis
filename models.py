...
class DFCVAE(BetaVAE):
    ...
    def __init__(self, latent_size=100, beta=1):
        ...
        # encoder
        #self.e1 = self._conv(3, 32) #expected input [32, 3, 4, 4] // input image 32x4x4 // my case 44x44x2
        self.e1 = self._conv(2, 22) #(44, 32)
        self.e2 = self._conv(22, 64)
